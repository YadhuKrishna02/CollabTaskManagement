...
const TaskTable = ({ tasks }) => {
  ...
  const TableRow = ({ task }) => (
    <tr className='w-full border-b border-gray-300 text-gray-600 hover:bg-gray-300/10'>
      <td className='py-2'>
...
const Dashboard = () => {
  ...
  const stats = [
    ...
    },
    {
      ...
      total: data?.data?.completedTasks || 0,
    ...
    },
    {
      ...
      total: data?.data?.inProgressTasks || 0,
    ...
    },
    {
      _id: "4",
      label: "TODOS",
      total: data?.data?.pendingTasks || 0,
      icon: <FaArrowsToDot />,
      bg: "bg-[#be185d]" || 0,
    },
  ];
